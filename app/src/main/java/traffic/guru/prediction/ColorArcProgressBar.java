...
//    private float hintSize = dipToPx(15);
    ...
    private void initCofig(Context context, AttributeSet attrs) {
        TypedArray a = context.obtainStyledAttributes(attrs, com.shinelw.library.R.styleable.ColorArcProgressBar);
        int color1 = a.getColor(com.shinelw.library.R.styleable.ColorArcProgressBar_front_color1, Color.GREEN);
        int color2 = a.getColor(com.shinelw.library.R.styleable.ColorArcProgressBar_front_color2, color1);
        int color3 = a.getColor(com.shinelw.library.R.styleable.ColorArcProgressBar_front_color3, color1);
        colors = new int[]{color1, color2, color3, color3};

        sweepAngle = a.getInteger(com.shinelw.library.R.styleable.ColorArcProgressBar_total_engle, 270);
        bgArcWidth = a.getDimension(com.shinelw.library.R.styleable.ColorArcProgressBar_back_width, dipToPx(2));
        progressWidth = a.getDimension(com.shinelw.library.R.styleable.ColorArcProgressBar_front_width, dipToPx(10));
        isNeedTitle = a.getBoolean(com.shinelw.library.R.styleable.ColorArcProgressBar_is_need_title, false);
        isNeedContent = a.getBoolean(com.shinelw.library.R.styleable.ColorArcProgressBar_is_need_content, false);
        isNeedUnit = a.getBoolean(com.shinelw.library.R.styleable.ColorArcProgressBar_is_need_unit, false);
        isNeedDial = a.getBoolean(com.shinelw.library.R.styleable.ColorArcProgressBar_is_need_dial, false);
        hintString = a.getString(com.shinelw.library.R.styleable.ColorArcProgressBar_string_unit);
        titleString = a.getString(com.shinelw.library.R.styleable.ColorArcProgressBar_string_title);
        curValues = a.getFloat(com.shinelw.library.R.styleable.ColorArcProgressBar_current_value, 0);
        maxValues = a.getFloat(com.shinelw.library.R.styleable.ColorArcProgressBar_max_value, 60);
...
//        diameter = 3 * getScreenWidth() / 5;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (isNeedContent) {
            canvas.drawText(String.format("%.0f%s", curValues,"%"), centerX, centerY + textSize / 3, vTextPaint);
        }
        if (isNeedUnit) {
